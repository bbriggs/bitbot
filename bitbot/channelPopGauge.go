...
var ChannelPopGaugeTrigger = NamedTrigger{ //nolint:gochecknoglobals,golint
	ID:   "channelPopGauge",
...
var HandleListReplyTrigger = NamedTrigger{ //nolint:gochecknoglobals,golint
	ID:   "handleListReply",
...
var SetChanPopGaugeTrigger = NamedTrigger{ //nolint:gochecknoglobals,golint
